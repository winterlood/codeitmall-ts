...
import { fetchProduct, fetchSizeReviews } from "@/lib/api";
...
export async function getServerSideProps(
  ...
  const sizeReviews = await fetchSizeReviews(productId);
            ...
            >
              ...
              <label className={styles.label}>
                ...
                <Dropdown
                  ...
                  options={[
                    ...
                    {
                      label: sizeReviewLabels.sex["female"],
                      value: "female",
                    },
                  ]}
                />
              ...
              <label className={styles.label}>
                ...
                <Dropdown
                  ...
                  options={[
                    {
                      label: sizeReviewLabels.fit["small"],
                      value: "small",
                    },
                    {
